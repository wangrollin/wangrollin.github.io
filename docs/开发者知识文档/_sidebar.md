    ...
    * 🗂产品
        * 🗂CNCF
            * 🗂容器运行时和容器引擎
                * 🗂docker
                    * 🗂UI
                        * [📝portainer](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/00_容器运行时和容器引擎/00_docker/UI/portainer.md)
                    * [📝docker-compose](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/00_容器运行时和容器引擎/00_docker/docker-compose.md)
                ...
                * 🗂OCI-Open-Container-Initiative
                    ...
                    * 🗂原生运行时
                        * [📝Crun](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/00_容器运行时和容器引擎/01_OCI-Open-Container-Initiative/01_原生运行时/Crun.md)
                        * [📝runC](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/00_容器运行时和容器引擎/01_OCI-Open-Container-Initiative/01_原生运行时/runC.md)
                    * 🗂沙盒虚拟运行时
                        * 🗂沙盒运行时
                            * [📝沙盒](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/00_容器运行时和容器引擎/01_OCI-Open-Container-Initiative/02_沙盒虚拟运行时/沙盒运行时/00_沙盒.md)
                            * [📝gviso](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/00_容器运行时和容器引擎/01_OCI-Open-Container-Initiative/02_沙盒虚拟运行时/沙盒运行时/gviso.md)
                            * [📝nabla-containers](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/00_容器运行时和容器引擎/01_OCI-Open-Container-Initiative/02_沙盒虚拟运行时/沙盒运行时/nabla-containers.md)
                        * 🗂虚拟运行时
            ...
            * 🗂paas
                * 🗂cloud_foundry
                    * [📝CloudFoundry](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/01_cloud_foundry/CloudFoundry.md)
                    * [📝KubeCF](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/01_cloud_foundry/KubeCF.md)
                    * [📝bosh](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/01_cloud_foundry/bosh.md)
                    * [📝cf-for-k8s](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/01_cloud_foundry/cf-for-k8s.md)
                    * [📝cfdev](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/01_cloud_foundry/cfdev.md)
                    * [📝kubo](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/01_cloud_foundry/kubo.md)
                * 🗂k8s
                    * [📝Lynda_Kubernetes_Cloud_Native_Ecosystem](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/Lynda_Kubernetes_Cloud_Native_Ecosystem.md)
                    * [📝Lynda_Kubernetes_Microservices](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/Lynda_Kubernetes_Microservices.md)
                    * [📝Lynda_Kubernetes_for_Java_Developers](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/Lynda_Kubernetes_for_Java_Developers.md)
                    * [📝Lynda_Learning_Azure_Kubernetes_Service-AKS](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/Lynda_Learning_Azure_Kubernetes_Service-AKS.md)
                    * [📝Lynda_Learning_Kubernetes](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/Lynda_Learning_Kubernetes.md)
                    * 🗂k8s发行版-开发环境
                        * [📝minikube](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s发行版-开发环境/minikube.md)
                    * 🗂k8s发行版-普通版
                        * [📝KubeOperator](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s发行版-普通版/KubeOperator.md)
                        * [📝RKE-Rancher_Kubernetes_Engine](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s发行版-普通版/RKE-Rancher_Kubernetes_Engine.md)
                        * [📝k0s](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s发行版-普通版/k0s.md)
                        * [📝k8s-原生](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s发行版-普通版/k8s-原生.md)
                        * [📝microk8s](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s发行版-普通版/microk8s.md)
                    * 🗂k8s发行版-边缘计算
                        * [📝SuperEdge](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s发行版-边缘计算/SuperEdge.md)
                        * [📝k3s](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s发行版-边缘计算/k3s.md)
                    ...
                    * 🗂k8s组件生态
                        ...
                        * 🗂存储
                            ...
                            * [📝storage](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/存储/storage.md)
                            * [📝zfs](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/存储/zfs.md)
                            * 🗂块存储
                                * [📝Longhorn](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/存储/块存储/Longhorn.md)
                        * 🗂工具镜像
                            * [📝BusyBox](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/工具镜像/BusyBox.md)
                        * 🗂应用部署测试工具
                            * 🗂OAM
                                * [📝CUE](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/应用部署测试工具/OAM/CUE.md)
                                * [📝KubeVela](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/应用部署测试工具/OAM/KubeVela.md)
                                * [📝OAM](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/应用部署测试工具/OAM/OAM.md)
                            * [📝Tilt](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/应用部署测试工具/Tilt.md)
                            * 🗂argo
                                * [📝argo](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/应用部署测试工具/argo/00_argo.md)
                                * [📝argo-cd](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/应用部署测试工具/argo/argo-cd.md)
                                * [📝argo-events](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/应用部署测试工具/argo/argo-events.md)
                                * [📝argo-rollouts](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/应用部署测试工具/argo/argo-rollouts.md)
                                * [📝argo-workflows](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/应用部署测试工具/argo/argo-workflows.md)
                        ...
                        * 🗂开放接口
                            * 🗂CNI-Container_Network_Interface
                                * [📝cilium](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/开放接口/CNI-Container_Network_Interface/cilium.md)
                            * 🗂CRI-Container_Runtime_Interface
                                * [📝CRI](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/开放接口/CRI-Container_Runtime_Interface/00_CRI.md)
                                * 🗂containerd
                                    * [📝containerd](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/开放接口/CRI-Container_Runtime_Interface/containerd/containerd.md)
                                    * [📝nerdctl](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/开放接口/CRI-Container_Runtime_Interface/containerd/nerdctl.md)
                                * [📝cri-ctl](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/开放接口/CRI-Container_Runtime_Interface/cri-ctl.md)
                                * 🗂cri-o
                                    * [📝cri-o](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/开放接口/CRI-Container_Runtime_Interface/cri-o/cri-o.md)
                                * 🗂podman
                                    * [📝podman](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/开放接口/CRI-Container_Runtime_Interface/podman/podman.md)
                                * [📝容器引擎](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/开放接口/CRI-Container_Runtime_Interface/容器引擎.md)
                            * 🗂CSI-Container_Storage_Interface
                                * [📝placeholder](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/开放接口/CSI-Container_Storage_Interface/placeholder.md)
                        * 🗂扩展套件
                            * [📝OpenKruise](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/扩展套件/OpenKruise.md)
                        * 🗂机器学习
                            * [📝kubeflow](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/机器学习/kubeflow.md)
                        * 🗂管理工具
                            * 🗂app
                                * [📝lens](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/app/lens.md)
                            * 🗂cli
                                * [📝DevSpace](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/cli/DevSpace.md)
                                * [📝k9s](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/cli/k9s.md)
                                * [📝kubeadm](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/cli/kubeadm.md)
                                * [📝kubectl](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/cli/kubectl.md)
                            * 🗂web
                                * [📝DevSpace](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/web/DevSpace.md)
                                * [📝Kuboard](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/web/Kuboard.md)
                                * [📝k8s_dashboard](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/web/k8s_dashboard.md)
                                * [📝kubesphere](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/web/kubesphere.md)
                                * [📝loft](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/web/loft.md)
                                * [📝openshift](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/web/openshift.md)
                                * [📝rancher](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/管理工具/web/rancher.md)
                        * 🗂网络
                            * 🗂DNS
                                * [📝Kube-DNS](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/02_k8s/k8s组件生态/网络/DNS/Kube-DNS.md)
                            * 🗂Ingress
                ...
                * 🗂微服务架构
                    * 🗂service_mesh
                        ...
                        * [📝Traffic_Director](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/03_微服务架构/01_service_mesh/Traffic_Director.md)
                        * [📝envoy](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/03_微服务架构/01_service_mesh/envoy.md)
                        * [📝istio](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/03_微服务架构/01_service_mesh/istio.md)
                        * [📝linkerd](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/03_微服务架构/01_service_mesh/linkerd.md)
                        * [📝概念](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/03_微服务架构/01_service_mesh/概念.md)
                    * 🗂mecha
                        * [📝mecha](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/03_微服务架构/02_mecha/00_mecha.md)
                        * [📝Dapr](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/02_paas/03_微服务架构/02_mecha/Dapr.md)
            * 🗂faas
                * [📝Dapr](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/Dapr.md)
                * [📝IronFunctions](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/IronFunctions.md)
                * [📝KEDA](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/KEDA.md)
                * [📝Knative](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/Knative.md)
                * [📝Kubeless](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/Kubeless.md)
                * [📝OpenFaas](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/OpenFaas.md)
                * [📝OpenFunction](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/OpenFunction.md)
                * [📝fission](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/fission.md)
                * [📝openwhisk](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/openwhisk.md)
                * 🗂前端低代码
                    * [📝mall-cook](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/03_faas/前端低代码/mall-cook.md)
            * [📝CNCF概览](/docs/开发者知识文档/11_云平台/02_产品/00_CNCF/CNCF概览.md)
        * 🗂计算
            * [📝ECS云服务器](/docs/开发者知识文档/11_云平台/02_产品/01_计算/ECS云服务器.md)
            * 🗂GNU-Linux
                * 🗂bash
                ...
                * 🗂c
                    * 🗂c版本
                        ...
                        * [📝c89](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/00_c版本/c89.md)
                        * [📝c99](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/00_c版本/c99.md)
                    * 🗂语法
                        * [📝语法](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/01_语法/语法.md)
                    * 🗂运行时
                        * [📝run-time](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/02_运行时/run-time.md)
                    * 🗂c标准库
                        * [📝c-standard-lib](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/03_c标准库/c-standard-lib.md)
                    * 🗂glibc
                        * [📝glibc](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/04_glibc/glibc.md)
                    * 🗂编译器
                        * [📝LLVM](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/05_编译器/LLVM.md)
                        * [📝clang](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/05_编译器/clang.md)
                        * [📝gcc](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/05_编译器/gcc.md)
                        * 🗂检查
                    ...
                    * 🗂框架和库
                        ...
                        * 🗂内存分配
                            * [📝jemalloc](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/07_框架和库/内存分配/jemalloc.md)
                            * [📝ptmalloc](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/07_框架和库/内存分配/ptmalloc.md)
                            * [📝tcmalloc](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/00_c/07_框架和库/内存分配/tcmalloc.md)
                        * 🗂压缩库
                ...
                * 🗂内核
                    * 🗂机制
                        * [📝cgroups](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/01_内核/00_机制/cgroups.md)
                    ...
                    * 🗂内存管理
                        * [📝内存管理](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/01_内核/03_内存管理/内存管理.md)
                    * 🗂文件系统
                        * [📝ext4](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/01_内核/04_文件系统/ext4.md)
                        * [📝zfs](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/01_内核/04_文件系统/zfs.md)
                        * [📝文件系统](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/01_内核/04_文件系统/文件系统.md)
                    * 🗂网络协议栈
                        * [📝tcpip](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/01_内核/05_网络协议栈/tcpip.md)
                    * [📝总览](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/01_内核/总览.md)
                    * 🗂顶级子系统
                        * [📝eBPF](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/01_内核/顶级子系统/eBPF.md)
                * 🗂GNU和其他工具软件
                    * 🗂CLI强化工具
                        * [📝eval](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/CLI强化工具/eval.md)
                        * [📝watch](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/CLI强化工具/watch.md)
                    * 🗂CPU架构
                    ...
                    * [📝seccomp](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/seccomp.md)
                    * 🗂session管理
                        * [📝ssh](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/session管理/ssh.md)
                        * [📝tmux](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/session管理/tmux.md)
                    * 🗂二进制工具库
                        * [📝Binutils总览](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/二进制工具库/00_Binutils总览.md)
                        * [📝objdump](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/二进制工具库/objdump.md)
                    * 🗂内核调试
                        * [📝kgdb](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/内核调试/kgdb.md)
                        * [📝kprobe](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/内核调试/kprobe.md)
                    * 🗂切割文件
                    ...
                    * 🗂密码加密
                        * 🗂加密协议
                            * [📝GnuPG](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/密码加密/加密协议/GnuPG.md)
                            * [📝OpenSSL](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/密码加密/加密协议/OpenSSL.md)
                            * [📝TLS](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/密码加密/加密协议/TLS.md)
                        * 🗂哈希算法
                            * 🗂不会冲突的
                                * [📝SHA-256](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/密码加密/哈希算法/不会冲突的/SHA-256.md)
                            * 🗂会哈希冲突的
                                * [📝MD5](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/密码加密/哈希算法/会哈希冲突的/MD5.md)
                    ...
                    * 🗂查看文件
                        ...
                        * 🗂阅读文本
                            ...
                            * [📝most](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/查看文件/阅读文本/most.md)
                            * [📝tail](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/查看文件/阅读文本/tail.md)
                            * [📝view](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/查看文件/阅读文本/view.md)
                    * 🗂查看目录_磁盘
                        * [📝df_du](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/查看目录_磁盘/df_du.md)
                        * [📝findmnt](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/查看目录_磁盘/findmnt.md)
                    ...
                    * 🗂编辑文件
                        ...
                        * [📝vi](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/编辑文件/vi.md)
                        * [📝vim](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/编辑文件/vim.md)
                    * 🗂网络相关
                        * [📝WireGuard](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/网络相关/WireGuard.md)
                        * [📝ip](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/网络相关/ip.md)
                        * [📝iptable](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/网络相关/iptable.md)
                        * [📝ipvadm](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/网络相关/ipvadm.md)
                        * [📝nc_netcat](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/网络相关/nc_netcat.md)
                        * [📝netstat](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/网络相关/netstat.md)
                    ...
                    * 🗂进程相关
                        ...
                        * 🗂执行命令
                            * [📝exec](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/进程相关/执行命令/exec.md)
                            * [📝sh](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/02_GNU和其他工具软件/进程相关/执行命令/sh.md)
                ...
                * 🗂ubuntu
                    * [📝linux常用命令](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/05_ubuntu/linux常用命令.md)
                    * [📝ubuntu](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/05_ubuntu/ubuntu.md)
                ...
                * 🗂其他发行版
                    ...
                    * 🗂nas类
                        * [📝TrueNas](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/nas类/TrueNas.md)
                    * 🗂server
                        * [📝Rocky_Linux](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/server/Rocky_Linux.md)
                        * [📝centos](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/server/centos.md)
                        * [📝openEuler](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/server/openEuler.md)
                        * [📝openSUSE](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/server/openSUSE.md)
                        * [📝redhat](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/server/redhat.md)
                    * [📝slackware](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/slackware.md)
                    * [📝tails](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/tails.md)
                    * 🗂基础镜像
                        * [📝alpine](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/基础镜像/alpine.md)
                    * 🗂安全类
                        * [📝kali](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/安全类/kali.md)
                    * 🗂桌面
                        * [📝Fedora](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/桌面/Fedora.md)
                        * [📝Gentoo](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/桌面/Gentoo.md)
                        * [📝arch](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/桌面/arch.md)
                        * [📝debian](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/桌面/debian.md)
                        * [📝deepin](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/桌面/deepin.md)
                        * [📝manjaro](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/06_其他发行版/桌面/manjaro.md)
                    * 🗂路由器
                ...
                * 🗂包管理工具
                    ...
                    * 🗂apt家族
                        ...
                        * [📝dpkg](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/07_包管理工具/apt家族/dpkg.md)
                ...
                * 🗂Linux社区项目
                    * 🗂文档
                        * [📝tldp](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/Linux社区项目/文档/tldp.md)
                * 🗂其他语言
                    * 🗂cpp
                        * [📝cpp](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/cpp/cpp.md)
                        * [📝cpp17](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/cpp/cpp17.md)
                    * 🗂go
                        * [📝go](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/go/go.md)
                        * 🗂内嵌DB
                            * [📝BoltDB](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/go/内嵌DB/BoltDB.md)
                            * [📝bbolt](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/go/内嵌DB/bbolt.md)
                    * 🗂lisp
                        * [📝lisp](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/lisp/lisp.md)
                    * 🗂lua
                        * [📝lua](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/lua/lua.md)
                    * 🗂prolog
                        * [📝prolog](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/prolog/prolog.md)
                    * 🗂ruby
                        * [📝Bundler](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/ruby/Bundler.md)
                        * [📝Gem](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/其他语言/ruby/Gem.md)
                ...
                * 🗂系统API
                    * [📝POSIX](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/系统API/POSIX.md)
                    * [📝系统调用](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/系统API/系统调用.md)
                * 🗂网络编程
                    * [📝C10K问题](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/网络编程/C10K问题.md)
                * 🗂虚拟化技术
                    * [📝LXC](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GNU-Linux/虚拟化技术/LXC.md)
            * [📝GPU云服务器](/docs/开发者知识文档/11_云平台/02_产品/01_计算/GPU云服务器.md)
            * [📝弹性裸金属服务器](/docs/开发者知识文档/11_云平台/02_产品/01_计算/弹性裸金属服务器.md)
            * 🗂消息中间件
                * [📝AMQP协议](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/AMQP协议.md)
                * 🗂Pulsar.md
                    * [📝pulsar_apache](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/Pulsar.md/pulsar_apache.md)
                * 🗂ZeroMQ
                    * [📝ZeroMQ](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/ZeroMQ/ZeroMQ.md)
                * 🗂activemq
                    * [📝activemq](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/activemq/01_activemq.md)
                * 🗂kafka
                    * [📝kafka](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/kafka/03_kafka.md)
                    * 🗂confluent
                        * [📝ConfluentSchemaRegistry](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/kafka/confluent/ConfluentSchemaRegistry.md)
                        * [📝Kafka-Schema-Registry](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/kafka/confluent/Kafka-Schema-Registry.md)
                        * [📝apache_confluent](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/kafka/confluent/apache_confluent.md)
                * [📝nsq](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/nsq.md)
                * 🗂rabbitMQ
                    * [📝rabbitMQ](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/rabbitMQ/02_rabbitMQ.md)
                * 🗂rocketMQ
                    * [📝rocketMQ](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/rocketMQ/04_rocketMQ.md)
                * [📝消息中间件概述](/docs/开发者知识文档/11_云平台/02_产品/01_计算/消息中间件/消息中间件概述.md)
        * 🗂存储
            * 🗂文件系统_存储排列组合
                * 🗂Block_块存储
                    * [📝云盘](/docs/开发者知识文档/11_云平台/02_产品/02_存储/01_文件系统_存储排列组合/Block_块存储/云盘.md)
                * 🗂块-对象
                    * [📝Sheepdog](/docs/开发者知识文档/11_云平台/02_产品/02_存储/01_文件系统_存储排列组合/块-对象/Sheepdog.md)
                    * [📝Swift](/docs/开发者知识文档/11_云平台/02_产品/02_存储/01_文件系统_存储排列组合/块-对象/Swift.md)
                * 🗂块-对象-文件
                    * 🗂分布式存储
                        * [📝Ceph](/docs/开发者知识文档/11_云平台/02_产品/02_存储/01_文件系统_存储排列组合/块-对象-文件/分布式存储/Ceph.md)
                * 🗂对象
                    * [📝minIO](/docs/开发者知识文档/11_云平台/02_产品/02_存储/01_文件系统_存储排列组合/对象/minIO.md)
                * 🗂文件
            ...
            * 🗂DB
                ...
                * 🗂数据库产品
                    ...
                    * 🗂NoSQL数据库
                        * 🗂KV类型
                            ...
                            * [📝Pegasus_小米](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库产品/01_NoSQL数据库/01_KV类型/Pegasus_小米.md)
                            * [📝RocksDB](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库产品/01_NoSQL数据库/01_KV类型/RocksDB.md)
                            * [📝Tendis_腾讯](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库产品/01_NoSQL数据库/01_KV类型/Tendis_腾讯.md)
                            * [📝TiKV](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库产品/01_NoSQL数据库/01_KV类型/TiKV.md)
                            * [📝Zeppelin_360](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库产品/01_NoSQL数据库/01_KV类型/Zeppelin_360.md)
                        * 🗂列存储
                            * [📝placeholder](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库产品/01_NoSQL数据库/02_列存储/placeholder.md)
                        * 🗂图形数据库
                        ...
                        * 🗂时序类
                            ...
                            * [📝influxdb](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库产品/01_NoSQL数据库/05_时序类/influxdb.md)
                ...
                * [📝数据库理论](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库理论.md)
                * 🗂数据库迁移
                    * [📝flyway](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库迁移/flyway.md)
                    * [📝liquibase](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库迁移/liquibase.md)
                * 🗂数据库锁
                    * [📝乐观锁](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库锁/乐观锁.md)
                    * [📝互斥锁](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库锁/互斥锁.md)
                    * [📝悲观锁](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库锁/悲观锁.md)
                    * [📝自旋锁](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库锁/自旋锁.md)
                    * [📝读写锁](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库锁/读写锁.md)
                * 🗂数据库集群
                    * 🗂主从读写分离-负载平衡
                        * 🗂mysql
                            * [📝总览](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/00_总览.md)
                            * [📝Atlas](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/Atlas.md)
                            * [📝MaxScale](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/MaxScale.md)
                            * [📝MyCat](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/MyCat.md)
                            * [📝mysql-proxy](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/mysql-proxy.md)
                            * [📝proxysql](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/proxysql.md)
                        * 🗂postgresql
                            * [📝Pgpool](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库集群/主从读写分离-负载平衡/postgresql/Pgpool.md)
                            * [📝PlProxy](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库集群/主从读写分离-负载平衡/postgresql/PlProxy.md)
                    * 🗂分库分表
                        * [📝ShardingSphere](/docs/开发者知识文档/11_云平台/02_产品/02_存储/04_DB/数据库集群/分库分表/ShardingSphere.md)
            * 🗂keyvalue存储
                * [📝minikeyvalue](/docs/开发者知识文档/11_云平台/02_产品/02_存储/05_keyvalue存储/minikeyvalue.md)
            * 🗂搜索引擎
                * [📝搜索引擎概述](/docs/开发者知识文档/11_云平台/02_产品/02_存储/06_搜索引擎/00_搜索引擎概述.md)
                * [📝elasticsearch](/docs/开发者知识文档/11_云平台/02_产品/02_存储/06_搜索引擎/elasticsearch.md)
                * [📝solr](/docs/开发者知识文档/11_云平台/02_产品/02_存储/06_搜索引擎/solr.md)
                * [📝sphinx](/docs/开发者知识文档/11_云平台/02_产品/02_存储/06_搜索引擎/sphinx.md)
            * 🗂一致性
                * [📝Consul_by_Hashicorp](/docs/开发者知识文档/11_云平台/02_产品/02_存储/07_一致性/Consul_by_Hashicorp.md)
                * [📝Doozerd](/docs/开发者知识文档/11_云平台/02_产品/02_存储/07_一致性/Doozerd.md)
                * [📝etcd](/docs/开发者知识文档/11_云平台/02_产品/02_存储/07_一致性/etcd.md)
                * [📝zookeeper](/docs/开发者知识文档/11_云平台/02_产品/02_存储/07_一致性/zookeeper.md)
            * 🗂kms_secret
                * [📝vault_by_Hashicorp](/docs/开发者知识文档/11_云平台/02_产品/02_存储/08_kms_secret/vault_by_Hashicorp.md)
            * 🗂Cache
                * 🗂分布式缓存
                    * [📝Hazelcast](/docs/开发者知识文档/11_云平台/02_产品/02_存储/09_Cache/分布式缓存/Hazelcast.md)
                    * [📝infinispan](/docs/开发者知识文档/11_云平台/02_产品/02_存储/09_Cache/分布式缓存/infinispan.md)
                    * [📝memcache](/docs/开发者知识文档/11_云平台/02_产品/02_存储/09_Cache/分布式缓存/memcache.md)
                    * 🗂redis
                        * 🗂Redis高可用
                            * [📝高可用](/docs/开发者知识文档/11_云平台/02_产品/02_存储/09_Cache/分布式缓存/redis/Redis高可用/高可用.md)
                        * [📝codis](/docs/开发者知识文档/11_云平台/02_产品/02_存储/09_Cache/分布式缓存/redis/codis.md)
                        * [📝redis](/docs/开发者知识文档/11_云平台/02_产品/02_存储/09_Cache/分布式缓存/redis/redis.md)
                * 🗂本地缓存
        ...
        * 🗂网络
            ...
            * [📝NAT_Gateway](/docs/开发者知识文档/11_云平台/02_产品/04_网络/NAT_Gateway.md)
            * [📝VPN网关](/docs/开发者知识文档/11_云平台/02_产品/04_网络/VPN网关.md)
            * [📝公网IP_EIP](/docs/开发者知识文档/11_云平台/02_产品/04_网络/公网IP_EIP.md)
        ...
        * 🗂中间件
            ...
            * 🗂LSP语言服务器协议
                * [📝ms-lsp](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/LSP语言服务器协议/ms-lsp.md)
            * 🗂分布式事务
                * [📝seata](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/分布式事务/seata.md)
            * 🗂分布式调度与计算框架
                * [📝PowerJob](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/分布式调度与计算框架/PowerJob.md)
            * 🗂序列化
                * [📝JSON_Schema](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/序列化/JSON_Schema.md)
            * 🗂待分类_by_redHat
                * 🗂redhat_middleware
                    * [📝quarkus](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/待分类_by_redHat/redhat_middleware/quarkus.md)
                    * [📝redHat_runtimes](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/待分类_by_redHat/redhat_middleware/redHat_runtimes.md)
            * 🗂混沌实验
                * [📝ChaosBlade](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/混沌实验/ChaosBlade.md)
            * 🗂网关
                * 🗂API网关
                    * [📝Kong](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/API网关/Kong.md)
                    * [📝apisix](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/API网关/apisix.md)
                * 🗂Java应用服务器
                    * [📝apache](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/Java应用服务器/apache.md)
                    * [📝jetty](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/Java应用服务器/jetty.md)
                    * [📝tomcat](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/Java应用服务器/tomcat.md)
                    * [📝undertow](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/Java应用服务器/undertow.md)
                    * 🗂全功能JakartaEE标准服务器
                        * [📝GlassFish](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/Java应用服务器/全功能JakartaEE标准服务器/GlassFish.md)
                        * [📝WildFly_JBoss](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/Java应用服务器/全功能JakartaEE标准服务器/WildFly_JBoss.md)
                * 🗂Python应用服务器
                    * [📝Gunicorn](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/Python应用服务器/Gunicorn.md)
                    * [📝werkzeug](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/Python应用服务器/werkzeug.md)
                * 🗂web服务器
                    * [📝nginx](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/网关/web服务器/nginx.md)
            * 🗂语音识别工具
                * [📝vosk](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/语音识别工具/vosk.md)
            * 🗂集群管理器
                * [📝mesos](/docs/开发者知识文档/11_云平台/02_产品/06_中间件/集群管理器/mesos.md)
        * 🗂数据平台
            * 🗂存储调度
                * 🗂存储
                    * 🗂数据格式
                    ...
                    * 🗂数据湖
                        * [📝Delta_Lake](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/00_存储/03_数据湖/Delta_Lake.md)
                    ...
                    * 🗂湖仓一体_ LakeHouse_Architecture 
                        * [📝总览](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/00_存储/04_湖仓一体_ LakeHouse_Architecture /总览.md)
                    * 🗂OLAP_DB
                ...
                * 🗂存算一体_hadoop_hdfs_yarn
                    * 🗂hadoop和发行版
                        * 🗂CDH
                            * [📝HUE](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/1_存算一体_hadoop_hdfs_yarn/00_hadoop和发行版/CDH/HUE.md)
                        * [📝Lynda_Learning_Hadoop](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/1_存算一体_hadoop_hdfs_yarn/00_hadoop和发行版/Lynda_Learning_Hadoop.md)
                        * [📝ambari](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/1_存算一体_hadoop_hdfs_yarn/00_hadoop和发行版/ambari.md)
                        * [📝cloudera_sandbox](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/1_存算一体_hadoop_hdfs_yarn/00_hadoop和发行版/cloudera_sandbox.md)
                        * [📝cloudera发行版安装包](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/1_存算一体_hadoop_hdfs_yarn/00_hadoop和发行版/cloudera发行版安装包.md)
                        * [📝hadoop](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/1_存算一体_hadoop_hdfs_yarn/00_hadoop和发行版/hadoop.md)
                        * [📝最佳实践](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/1_存算一体_hadoop_hdfs_yarn/00_hadoop和发行版/最佳实践.md)
                    * 🗂存储
                        * [📝hdfs](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/1_存算一体_hadoop_hdfs_yarn/存储/hdfs.md)
                    * 🗂调度
                        * [📝yarn](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/01_存储调度/1_存算一体_hadoop_hdfs_yarn/调度/yarn.md)
            ...
            * 🗂开发套件_DataOps
                ...
                * 🗂数据研发
                    * 🗂数据集成
                        * [📝Airbyte](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/00_数据集成/Airbyte.md)
                        * [📝Binlog_Kafka](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/00_数据集成/Binlog_Kafka.md)
                        * [📝DataX](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/00_数据集成/DataX.md)
                        * [📝Flume](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/00_数据集成/Flume.md)
                        * [📝Gobblin](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/00_数据集成/Gobblin.md)
                        * [📝Sqoop](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/00_数据集成/Sqoop.md)
                    * 🗂调度系统
                        * 🗂开源实现
                            * [📝Airflow](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/01_调度系统/开源实现/Airflow.md)
                            * [📝Azkaban](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/01_调度系统/开源实现/Azkaban.md)
                            * [📝Crontab](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/01_调度系统/开源实现/Crontab.md)
                            * [📝DolphinScheduler](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/01_调度系统/开源实现/DolphinScheduler.md)
                            * [📝Oozie](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/01_调度系统/开源实现/Oozie.md)
                            * [📝Prefect](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/01_调度系统/开源实现/Prefect.md)
                            * [📝celery](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/01_调度系统/开源实现/celery.md)
                            * [📝chronos](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/01_调度系统/开源实现/chronos.md)
                    * 🗂任务实例运维
                        * [📝基线预警告警](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/02_任务实例运维/基线预警告警.md)
                        * [📝调度失败分析](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/02_任务实例运维/调度失败分析.md)
                    * 🗂临时查询notebook
                        * [📝Jupyter](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/03_临时查询notebook/Jupyter.md)
                        * [📝WebIDE](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/03_临时查询notebook/WebIDE.md)
                        * [📝Zeppelin](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/03_临时查询notebook/Zeppelin.md)
                    * 🗂开源解决方案
                        * [📝dbt_core](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/01_数据研发/99_开源解决方案/dbt_core.md)
                * 🗂数据资产
                    * [📝指标](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/02_数据资产/指标.md)
                    * 🗂数据地图_血缘关系
                        * 🗂开源实现
                            * [📝DataHub](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/02_数据资产/数据地图_血缘关系/开源实现/DataHub.md)
                            * [📝amundsen](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/02_数据资产/数据地图_血缘关系/开源实现/amundsen.md)
                            * [📝atlas](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/02_数据资产/数据地图_血缘关系/开源实现/atlas.md)
                        * [📝数据地图_血缘关系](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/02_数据资产/数据地图_血缘关系/数据地图_血缘关系.md)
                * 🗂数据治理
                    * [📝SLA治理](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/03_数据治理/SLA治理.md)
                    * [📝成本优化_元数仓](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/03_数据治理/成本优化_元数仓.md)
                    * [📝指标平台](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/03_数据治理/指标平台.md)
                    * [📝数据合规_删除和脱敏](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/03_数据治理/数据合规_删除和脱敏.md)
                    * 🗂数据安全_权限管理
                        * 🗂开源实现
                            * [📝ranger](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/03_数据治理/数据安全_权限管理/开源实现/ranger.md)
                            * [📝sentry](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/03_数据治理/数据安全_权限管理/开源实现/sentry.md)
                        * [📝数据安全_权限管理](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/03_数据治理/数据安全_权限管理/数据安全_权限管理.md)
                    * 🗂数据质量
                        * 🗂开源实现
                            * [📝Griffin](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/03_数据治理/数据质量/开源实现/Griffin.md)
                        * [📝数据质量](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件_DataOps/03_数据治理/数据质量/数据质量.md)
            * 🗂数仓建设
                * 🗂建模
                    * [📝纬度建模](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/05_数仓建设/建模/纬度建模.md)
                    * [📝范式建模](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/05_数仓建设/建模/范式建模.md)
                * [📝数据层级](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/05_数仓建设/数据层级.md)
            * 🗂数据应用
                * 🗂实验评估
                    * [📝AB测试](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/实验评估/AB测试.md)
                    * [📝多臂老虎机_Multi-Armed-Bandits_MAB](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/实验评估/多臂老虎机_Multi-Armed-Bandits_MAB.md)
                * 🗂推荐系统
                    * [📝推荐系统](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/推荐系统/推荐系统.md)
                    * [📝用户画像](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/推荐系统/用户画像.md)
                    * [📝行为分析](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/推荐系统/行为分析.md)
                * 🗂数据分析
                    * [📝DataStory](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/数据分析/DataStory.md)
                    * [📝数据建模](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/数据分析/数据建模.md)
                * [📝数据分析基础知识](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/数据分析基础知识.md)
                * 🗂数据可视化BI
                    * [📝dataV](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/数据可视化BI/dataV.md)
                    * [📝esForHadoop](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/数据可视化BI/esForHadoop.md)
                    * [📝jeecy](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/数据可视化BI/jeecy.md)
                    * [📝vueDataV](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/06_数据应用/数据可视化BI/vueDataV.md)
            * 🗂其他
                * 🗂数据生成器
                    * [📝mockaroo](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_数据生成器/mockaroo.md)
                * 🗂整体解决方案
                    * 🗂商业
                        * [📝GoogleAnalytics](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/GoogleAnalytics.md)
                        * [📝GrowingIO](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/GrowingIO.md)
                        * [📝dataphin](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/dataphin.md)
                        * [📝dataworks](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/dataworks.md)
                        * 🗂云数仓
                            * [📝DataOps.live](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/云数仓/DataOps.live.md)
                            * [📝Databricks](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/云数仓/Databricks.md)
                            * [📝Snowflake](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/云数仓/Snowflake.md)
                        * [📝星环](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/星环.md)
                        * [📝神策数据](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/神策数据.md)
                        * [📝诸葛IO](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/商业/诸葛IO.md)
                    * 🗂开源
                        * 🗂Byzer
                            * [📝Byzer_MLSQL](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/开源/Byzer/Byzer_MLSQL.md)
                        * 🗂WeDataSphere
                            * [📝WeDataSphere](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_整体解决方案/开源/WeDataSphere/WeDataSphere.md)
                * 🗂理论概念
                    * [📝OLAP](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_理论概念/OLAP.md)
                    * [📝PLTP](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_理论概念/PLTP.md)
                    * 🗂规范
                        * [📝上线规范](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_理论概念/规范/上线规范.md)
                        * [📝开发规范](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_理论概念/规范/开发规范.md)
                        * [📝模型规范](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_理论概念/规范/模型规范.md)
                        * [📝运维规范](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_理论概念/规范/运维规范.md)
                    * [📝计算模型](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_理论概念/计算模型.md)
                    * [📝质量](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/00_理论概念/质量.md)
                * 🗂SQL解析框架
                    * [📝calcite](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/99_其他/SQL解析框架/calcite.md)
        * 🗂AI平台
            * 🗂Python
                * 🗂IDE
                    * [📝PyCharm](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/IDE/PyCharm.md)
                * 🗂python发行版
                ...
                * 🗂基础
                    ...
                    * 🗂标准库
                        ...
                        * [📝标准库](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/基础/标准库/标准库.md)
                    * 🗂解释器
                        * [📝cpy](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/基础/解释器/cpy.md)
                        * [📝pypy](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/基础/解释器/pypy.md)
                * 🗂实用工具
                    * 🗂包管理
                        * 🗂客户端
                            * [📝Conda](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/包管理/客户端/Conda.md)
                            * [📝pip3](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/包管理/客户端/pip3.md)
                        * 🗂源
                            * [📝PyPI](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/包管理/源/PyPI.md)
                    * 🗂虚拟环境管理
                        * [📝venv](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/虚拟环境管理/00_venv.md)
                        * [📝Miniconda](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/虚拟环境管理/Miniconda.md)
                        * [📝hatch](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/虚拟环境管理/hatch.md)
                        * [📝pipenv](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/虚拟环境管理/pipenv.md)
                        * [📝poetry](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/虚拟环境管理/poetry.md)
                        * [📝pyenv](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/虚拟环境管理/pyenv.md)
                        * [📝virtualenv](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/实用工具/虚拟环境管理/virtualenv.md)
                * 🗂库
                    * 🗂CLI库
                        * [📝click](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/CLI库/click.md)
                    * 🗂SSHv2协议库
                    ...
                    * 🗂图像处理库
                        * [📝Pillow](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/图像处理库/Pillow.md)
                    * 🗂基础工具库
                        * [📝pyutil](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/基础工具库/pyutil.md)
                    * 🗂并发编程
                        * [📝greenlet](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/并发编程/greenlet.md)
                    * 🗂数值计算库
                        * [📝numpy](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/数值计算库/numpy.md)
                        * [📝pandas](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/数值计算库/pandas.md)
                        * [📝scipy](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/数值计算库/scipy.md)
                    * 🗂数据看板_画板
                        * [📝dash-Plotly](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/数据看板_画板/dash-Plotly.md)
                    * 🗂流水线构建
                        * [📝luigi](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/流水线构建/luigi.md)
                    * 🗂网络库
                        * 🗂ws
                            * [📝websocket-client](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/网络库/ws/websocket-client.md)
                            * [📝websockets](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/网络库/ws/websockets.md)
                    * 🗂语言处理库
                        * [📝jieba分词](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/库/语言处理库/jieba分词.md)
                * 🗂框架
                    * 🗂DB相关
                        * 🗂DB管理
                            * [📝Alembic](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/DB相关/DB管理/Alembic.md)
                            * [📝sqlacodegen](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/DB相关/DB管理/sqlacodegen.md)
                        * 🗂ORM
                            * [📝MongoEngine](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/DB相关/ORM/MongoEngine.md)
                            * [📝SQLALchemy](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/DB相关/ORM/SQLALchemy.md)
                            * [📝peewee](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/DB相关/ORM/peewee.md)
                            * [📝pymongo](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/DB相关/ORM/pymongo.md)
                    * 🗂Html渲染框架
                        * [📝Jinja2](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Html渲染框架/Jinja2.md)
                    * 🗂WSGI_Server
                        * 🗂blocking
                            * [📝Gunicorn](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/WSGI_Server/blocking/Gunicorn.md)
                        * 🗂non-blocking
                            * [📝Gevent](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/WSGI_Server/non-blocking/Gevent.md)
                            * [📝Tornado](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/WSGI_Server/non-blocking/Tornado.md)
                            * [📝eventlet](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/WSGI_Server/non-blocking/eventlet.md)
                    * 🗂Web框架
                        * 🗂Django
                            * [📝Django](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Django/00_Django.md)
                            * [📝django-admin](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Django/django-admin.md)
                        * [📝FastAPI](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/FastAPI.md)
                        * 🗂Flask
                            * [📝Flask](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/00_Flask.md)
                            * 🗂DB管理
                                * [📝Flask-Migrate](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/DB管理/Flask-Migrate.md)
                                * [📝Flask-Sqlalchemy](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/DB管理/Flask-Sqlalchemy.md)
                            * 🗂管理面
                                * [📝Flask-Admin](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/管理面/Flask-Admin.md)
                                * [📝Flask-AppBuilder](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/管理面/Flask-AppBuilder.md)
                            * 🗂网络
                                * [📝Flask-SocketIO](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/网络/Flask-SocketIO.md)
                            * 🗂认证授权
                                * [📝Flask-BasicAuth](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/认证授权/Flask-BasicAuth.md)
                                * [📝Flask-Login](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/认证授权/Flask-Login.md)
                                * [📝Flask-Security-Too](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/认证授权/Flask-Security-Too.md)
                            * 🗂跨域
                                * [📝Flask-Cors](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/Web框架/Flask/跨域/Flask-Cors.md)
                    * 🗂微服务
                        * [📝Euler微服务框架](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_Python/框架/微服务/Euler微服务框架.md)
            * 🗂其他
                * [📝人工智能安全](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_其他/人工智能安全.md)
                * [📝人工智能工程化（AI Engineering）](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_其他/人工智能工程化（AI Engineering）.md)
                * [📝多模态的CV+NLP](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_其他/多模态的CV+NLP.md)
                * 🗂深度学习编译器
                    * [📝MLIR](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_其他/深度学习编译器/MLIR.md)
                    * [📝TVM](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_其他/深度学习编译器/TVM.md)
                    * [📝XLA](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/00_其他/深度学习编译器/XLA.md)
            * 🗂数据管理
                * [📝数据采集](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/01_数据管理/01_数据采集.md)
                * [📝数据清洗](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/01_数据管理/02_数据清洗.md)
                * [📝数据标注](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/01_数据管理/03_数据标注.md)
                * [📝特征工程](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/01_数据管理/04_特征工程.md)
                * 🗂数据集
                    * [📝imageNet](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/01_数据管理/数据集/imageNet.md)
                    * [📝数据生成器](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/01_数据管理/数据集/数据生成器.md)
                * [📝有标记_无标记](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/01_数据管理/有标记_无标记.md)
            * 🗂算法_学习_模型
                * 🗂引擎
                    * [📝Caffe](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/Caffe.md)
                    * 🗂Keras
                        * [📝Lynda_Neural_Networks_and_Convolutional_Neural_Networks_Essential_Training](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/Keras/Lynda_Neural_Networks_and_Convolutional_Neural_Networks_Essential_Training.md)
                        * [📝keras](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/Keras/keras.md)
                    * [📝OpenCV](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/OpenCV.md)
                    * 🗂PyTorch
                        * [📝Lynda_PyTorch_Essential_Training_Deep_Learning](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/PyTorch/Lynda_PyTorch_Essential_Training_Deep_Learning.md)
                        * [📝PyTorch](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/PyTorch/PyTorch.md)
                    * [📝RLlib](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/RLlib.md)
                    * [📝Spark_ML](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/Spark_ML.md)
                    * 🗂Tensorflow
                        * [📝tensorflow](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/Tensorflow/tensorflow.md)
                        * 🗂可视化
                            * [📝Tensorboard](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/Tensorflow/可视化/Tensorboard.md)
                    * [📝XGBoost](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/XGBoost.md)
                    * [📝scikit-learn](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/00_引擎/scikit-learn.md)
                * 🗂训练_评价
                    * 🗂深度学习算法
                        * [📝概念](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/00_概念.md)
                        * [📝DNN](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/DNN.md)
                        * [📝DeepFM](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/DeepFM.md)
                        * [📝LSTM](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/LSTM.md)
                        * [📝MLM](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/MLM.md)
                        * [📝RLHF](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/RLHF.md)
                        * [📝RNN](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/RNN.md)
                        * [📝Transformer](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/Transformer.md)
                        * [📝卷积神经网络_CNNs](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/卷积神经网络_CNNs.md)
                        * [📝反向传播_BP](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/反向传播_BP.md)
                        * [📝增强学习](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/增强学习.md)
                        * [📝强化学习](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/强化学习.md)
                        * 🗂方法论
                            * [📝prompt工程](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/方法论/prompt工程.md)
                            * [📝模型蒸馏](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/方法论/模型蒸馏.md)
                        * [📝最小二乘法](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/最小二乘法.md)
                        * [📝梯度下降](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/梯度下降.md)
                        * [📝胶囊网络](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/01_深度学习算法/胶囊网络.md)
                    * [📝模型训练](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/02_模型训练.md)
                    * 🗂评价方法和标准
                        * [📝监督](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/02_评价方法和标准/00_监督.md)
                        * [📝半监督](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/02_评价方法和标准/01_半监督.md)
                        * [📝⽆监督_⾃监督](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/02_评价方法和标准/02_⽆监督_⾃监督.md)
                        * [📝强化学习_RL](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/02_评价方法和标准/03_强化学习_RL.md)
                    * [📝模型测试-实验](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/01_训练_评价/03_模型测试-实验.md)
                * 🗂模型
                    * 🗂机器学习模型_统计模型
                        * [📝LR](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/01_机器学习模型_统计模型/LR.md)
                        * [📝kNN](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/01_机器学习模型_统计模型/kNN.md)
                        * [📝决策树](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/01_机器学习模型_统计模型/决策树.md)
                        * [📝支持向量机_SVM](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/01_机器学习模型_统计模型/支持向量机_SVM.md)
                    * 🗂决策树模型
                        * 🗂树模型
                            * [📝GBDT](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/决策树模型/树模型/GBDT.md)
                            * [📝RF](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/决策树模型/树模型/RF.md)
                            * [📝XGB](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/决策树模型/树模型/XGB.md)
                    * [📝开发模型](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/开发模型.md)
                    * 🗂神经网络
                        * 🗂各领域的预训练模型
                            * 🗂NLP_文字转语义_机器翻译
                                * 🗂AIGC
                                    * [📝文心一言](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/AIGC/文心一言.md)
                                * [📝BERT](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/BERT.md)
                                * [📝Bard](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/Bard.md)
                                * [📝MS_Office_Copilot](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/MS_Office_Copilot.md)
                                * [📝New_Bing](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/New_Bing.md)
                                * [📝SwitchTransformer](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/SwitchTransformer.md)
                                * [📝alpaca](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/alpaca.md)
                                * [📝gbdt](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/gbdt.md)
                                * 🗂各种名词
                                    * [📝LLM](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/各种名词/00_LLM.md)
                                    * [📝AIGC](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/各种名词/AIGC.md)
                                    * [📝Colossal-AI](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/各种名词/Colossal-AI.md)
                                    * [📝GPT-4](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/各种名词/GPT-4.md)
                                    * [📝LangChain](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/各种名词/LangChain.md)
                                    * [📝llama-index](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/各种名词/llama-index.md)
                                    * [📝llama](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/01_NLP_文字转语义_机器翻译/各种名词/llama.md)
                            ...
                            * 🗂语音转文字
                                ...
                                * [📝HuBERT](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/02_语音转文字/HuBERT.md)
                                * [📝Wav2vec](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/02_语音转文字/Wav2vec.md)
                                * [📝WavLM](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/02_语音转文字/WavLM.md)
                            * 🗂CV_计算机视觉_ARVR_自动驾驶
                                * [📝placeholder](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/03_CV_计算机视觉_ARVR_自动驾驶/placeholder.md)
                            * [📝悟道2.0](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_各领域的预训练模型/悟道2.0.md)
                        * 🗂预训练模型_finetune
                            * [📝预训练模型_finetune](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/03_预训练模型_finetune/预训练模型_finetune.md)
                        * 🗂预训练模型_prompt_human_teaching
                            * [📝预训练模型_prompt_human_teaching](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/04_预训练模型_prompt_human_teaching/预训练模型_prompt_human_teaching.md)
                        * 🗂Transformers开源模型仓库
                            * [📝Huggingface](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/Transformers开源模型仓库/Huggingface.md)
                        * [📝生成匹配网络_GMNs](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/生成匹配网络_GMNs.md)
                        * [📝生成对抗网络_GANs](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/生成对抗网络_GANs.md)
                        * [📝生成式模型_判别式模型](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/神经网络/生成式模型_判别式模型.md)
                    * 🗂线性模型
                        * [📝placeholder](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/线性模型/placeholder.md)
                    * 🗂贝叶斯分类器
                        * [📝placeholder](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/02_模型/贝叶斯分类器/placeholder.md)
                * 🗂其他
                    * 🗂算力
                        * [📝NPU](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/02_算法_学习_模型/99_其他/算力/NPU.md)
            * 🗂模型部署
                * [📝ModelHub](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/01_ModelHub.md)
                * [📝ModelDeploy](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/02_ModelDeploy.md)
                * [📝ModelServer](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/03_ModelServer.md)
                * [📝ModelMonitor](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/04_ModelMonitor.md)
                * 🗂开源部署平台
                    * 🗂后端
                        * [📝seldon](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/开源部署平台/00_后端/seldon.md)
                    * 🗂客户端
                        * [📝端上智能](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/开源部署平台/01_客户端/端上智能.md)
                    * 🗂嵌入式设备
                        * [📝Tengine](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/开源部署平台/02_嵌入式设备/Tengine.md)
                        * [📝mnn](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/开源部署平台/02_嵌入式设备/mnn.md)
                        * [📝ncnn](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/开源部署平台/02_嵌入式设备/ncnn.md)
                        * [📝tnn](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/开源部署平台/02_嵌入式设备/tnn.md)
                    * 🗂模型演示平台
                        * [📝gradio](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/03_模型部署/开源部署平台/99_模型演示平台/gradio.md)
            * 🗂开源实现_MLOps
                * 🗂模型训练
                    * [📝ML_flow](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/98_开源实现_MLOps/00_模型训练/ML_flow.md)
                    * [📝kubeflow](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/98_开源实现_MLOps/00_模型训练/kubeflow.md)
                * 🗂模型部署
                    * [📝kserve](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/98_开源实现_MLOps/01_模型部署/kserve.md)
                    * [📝seldon-core](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/98_开源实现_MLOps/01_模型部署/seldon-core.md)
                * [📝OpenMMLab](/docs/开发者知识文档/11_云平台/02_产品/12_AI平台/98_开源实现_MLOps/OpenMMLab.md)
            * 🗂行业解决方案
                * 🗂开发工具链_代码辅助
