...
* 🗂软件开发
        ...
        * 🗂java
            * 🗂JDK
                * 🗂JDK-Tools
                    ...
                    * 🗂JVM监测工具
                        * [📝VisualVM](/docs/开发者知识文档/01_软件开发/02_后端/java/01_JDK/JDK-Tools/03_JVM监测工具/01_VisualVM.md)
                        * [📝JConsole](/docs/开发者知识文档/01_软件开发/02_后端/java/01_JDK/JDK-Tools/03_JVM监测工具/02_JConsole.md)
                        ...
                        * 🗂非JDK-Tool的工具
                            * [📝arthas_by_alibaba](/docs/开发者知识文档/01_软件开发/02_后端/java/01_JDK/JDK-Tools/03_JVM监测工具/非JDK-Tool的工具/arthas_by_alibaba.md)
                ...
                * 🗂spring全家桶
                    ...
                    * 🗂springBoot
                        ...
                        * 🗂spring-boot-starter-webflux
                            * [📝WebClient](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springBoot/spring-boot-starter-webflux/WebClient.md)
                        * [📝springboot](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springBoot/springboot.md)
                        * [📝springboot热加载](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springBoot/springboot热加载.md)
                    * 🗂springCloudDataFlow
                        * [📝springCloudDataFlow](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springCloudDataFlow/springCloudDataFlow.md)
                    * 🗂springData
                        * [📝Spring_Data_Jest](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springData/Spring_Data_Jest.md)
                        * [📝springDataJpa](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springData/springDataJpa.md)
                        * [📝springdata](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springData/springdata.md)
                    * 🗂springFramework
                        * [📝Lynda_Learning_Spring_with_SpringBoot](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springFramework/Lynda_Learning_Spring_with_SpringBoot.md)
                        * [📝Lynda_SpringFramework_In_Depth](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springFramework/Lynda_SpringFramework_In_Depth.md)
                        * [📝Lynda_Spring_5.0_and_SpringBoot2.0_NewFeatures](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springFramework/Lynda_Spring_5.0_and_SpringBoot2.0_NewFeatures.md)
                    ...
                    * 🗂springSession
                        * [📝springSession](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/springSession/springSession.md)
                    * [📝spring系列总揽](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/spring系列总揽.md)
                * 🗂微服务框架
                    * 🗂springCloud
                        * [📝HystrixDashbord](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/HystrixDashbord.md)
                        * [📝Hystrix_by_Netflix](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/Hystrix_by_Netflix.md)
                        * [📝Nacos_by_alibaba](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/Nacos_by_alibaba.md)
                        * [📝Ribbon_by_Netflix](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/Ribbon_by_Netflix.md)
                        * [📝Sleuth和zipkin](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/Sleuth和zipkin.md)
                        * [📝configServer](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/configServer.md)
                        * [📝eureka_by_Netflix](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/eureka_by_Netflix.md)
                        * [📝openFeign](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/openFeign.md)
                        * [📝springcloud](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/springcloud.md)
                        * [📝traefik](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/traefik.md)
                        * [📝webflux_gateway](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/webflux_gateway.md)
                        * [📝zuul](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/02_微服务框架/springCloud/zuul.md)
                * 🗂DI框架
            ...
            * 🗂第三方工具
                * 🗂诊断工具
                    * [📝Arthas](/docs/开发者知识文档/01_软件开发/02_后端/java/第三方工具/诊断工具/Arthas.md)
                    * [📝Bistoury](/docs/开发者知识文档/01_软件开发/02_后端/java/第三方工具/诊断工具/Bistoury.md)
                    * [📝vjtools](/docs/开发者知识文档/01_软件开发/02_后端/java/第三方工具/诊断工具/vjtools.md)
        * 🗂中间件
            * 🗂API网关
    ...
    * 🗂大数据平台
        ...
        * 🗂计算引擎
            * [📝Beam](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Beam.md)
            * 🗂Flink
                * [📝Lynda_Apache_Flink_Batch_Mode_Data_Engineering](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Flink/Lynda_Apache_Flink_Batch_Mode_Data_Engineering.md)
                * [📝Lynda_Apache_Flink_Exploratory_Data_Analytics_with_SQL](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Flink/Lynda_Apache_Flink_Exploratory_Data_Analytics_with_SQL.md)
                * [📝Lynda_Apache_Flink_Real-Time_Data_Engineering](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Flink/Lynda_Apache_Flink_Real-Time_Data_Engineering.md)
                * [📝flink](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Flink/flink.md)
            * [📝MR](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/MR.md)
            * 🗂Spark
                * [📝Lynda_Apache_Spark_Essential_Training](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Spark/Lynda_Apache_Spark_Essential_Training.md)
                * [📝Lynda_Big_Data_Analytics_with_Hadoop_and_Apache_Spark](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Spark/Lynda_Big_Data_Analytics_with_Hadoop_and_Apache_Spark.md)
                * [📝Lynda_Introduction_to_Spark_SQL_and_DataFrames](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Spark/Lynda_Introduction_to_Spark_SQL_and_DataFrames.md)
                * [📝spark](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Spark/spark.md)
            * [📝Tez](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/Tez.md)
            * [📝drill](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/drill.md)
            * [📝impala](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/impala.md)
            * [📝presto](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/presto.md)
            * [📝storm](/docs/开发者知识文档/01_软件开发/03_大数据平台/1_计算引擎/storm.md)
        * 🗂数据同步
            * [📝Binlog_Kafka](/docs/开发者知识文档/01_软件开发/03_大数据平台/2_数据同步/Binlog_Kafka.md)
            * [📝DataX](/docs/开发者知识文档/01_软件开发/03_大数据平台/2_数据同步/DataX.md)
            * [📝Flume](/docs/开发者知识文档/01_软件开发/03_大数据平台/2_数据同步/Flume.md)
            * [📝Sqoop](/docs/开发者知识文档/01_软件开发/03_大数据平台/2_数据同步/Sqoop.md)
        * 🗂调度
        ...
        * 🗂基础部署和管理
            * 🗂CDH
                * [📝HUE](/docs/开发者知识文档/01_软件开发/03_大数据平台/5_基础部署和管理/CDH/HUE.md)
        ...
        * 🗂理论和概念
            * [📝OLAP](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/OLAP.md)
            * [📝PLTP](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/PLTP.md)
            * 🗂建模
                * [📝纬度建模](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/建模/纬度建模.md)
                * [📝范式建模](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/建模/范式建模.md)
            * 🗂数据中台
                * [📝中台](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/数据中台/中台.md)
            * 🗂数据仓库DataWarehouse
            ...
            * 🗂数据湖DataLake
                ...
                * [📝Iceberg](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/数据湖DataLake/Iceberg.md)
                * [📝clickhouse](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/数据湖DataLake/clickhouse.md)
                * [📝delta](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/数据湖DataLake/delta.md)
                * [📝hive-acid](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/数据湖DataLake/hive-acid.md)
            * 🗂规范
                * [📝上线规范](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/规范/上线规范.md)
                * [📝开发规范](/docs/开发者知识文档/01_软件开发/03_大数据平台/6_理论和概念/规范/开发规范.md)
