...
* 🗂云平台
    ...
    * 🗂产品
        ...
        * 🗂数据平台
            ...
            * 🗂开发套件
                * 🗂数据采集
                    * [📝PlaceHolder_AppLog](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/00_数据采集/PlaceHolder_AppLog.md)
                * 🗂数据研发
                    * 🗂数据集成
                        * [📝Airbyte](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/00_数据集成/Airbyte.md)
                        * [📝Binlog_Kafka](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/00_数据集成/Binlog_Kafka.md)
                        * [📝DataX](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/00_数据集成/DataX.md)
                        * [📝Flume](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/00_数据集成/Flume.md)
                        * [📝Gobblin](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/00_数据集成/Gobblin.md)
                        * [📝Sqoop](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/00_数据集成/Sqoop.md)
                    * 🗂调度系统
                        * 🗂开源实现
                            * [📝Airflow](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/01_调度系统/开源实现/Airflow.md)
                            * [📝Azkaban](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/01_调度系统/开源实现/Azkaban.md)
                            * [📝Crontab](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/01_调度系统/开源实现/Crontab.md)
                            * [📝DolphinScheduler](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/01_调度系统/开源实现/DolphinScheduler.md)
                            * [📝Oozie](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/01_调度系统/开源实现/Oozie.md)
                            * [📝Prefect](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/01_调度系统/开源实现/Prefect.md)
                            * [📝celery](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/01_调度系统/开源实现/celery.md)
                            * [📝chronos](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/01_调度系统/开源实现/chronos.md)
                    * 🗂任务实例运维
                        * [📝基线预警告警](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/02_任务实例运维/基线预警告警.md)
                        * [📝调度失败分析](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/02_任务实例运维/调度失败分析.md)
                    * 🗂临时查询notebook
                        * [📝Jupyter](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/03_临时查询notebook/Jupyter.md)
                        * [📝WebIDE](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/03_临时查询notebook/WebIDE.md)
                        * [📝Zeppelin](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/03_临时查询notebook/Zeppelin.md)
                    * 🗂开源解决方案
                        * [📝dbt_core](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/01_数据研发/99_开源解决方案/dbt_core.md)
                * 🗂数据资产
                    * [📝指标](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/02_数据资产/指标.md)
                    * 🗂数据地图_血缘关系
                        * 🗂开源实现
                            * [📝DataHub](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/02_数据资产/数据地图_血缘关系/开源实现/DataHub.md)
                            * [📝amundsen](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/02_数据资产/数据地图_血缘关系/开源实现/amundsen.md)
                            * [📝atlas](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/02_数据资产/数据地图_血缘关系/开源实现/atlas.md)
                        * [📝数据地图_血缘关系](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/02_数据资产/数据地图_血缘关系/数据地图_血缘关系.md)
                * 🗂数据治理
                    * [📝SLA治理](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/03_数据治理/SLA治理.md)
                    * [📝成本优化_元数仓](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/03_数据治理/成本优化_元数仓.md)
                    * [📝指标平台](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/03_数据治理/指标平台.md)
                    * [📝数据合规_删除和脱敏](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/03_数据治理/数据合规_删除和脱敏.md)
                    * 🗂数据安全_权限管理
                        * 🗂开源实现
                            * [📝ranger](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/03_数据治理/数据安全_权限管理/开源实现/ranger.md)
                            * [📝sentry](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/03_数据治理/数据安全_权限管理/开源实现/sentry.md)
                        * [📝数据安全_权限管理](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/03_数据治理/数据安全_权限管理/数据安全_权限管理.md)
                    * 🗂数据质量
                        * 🗂开源实现
                            * [📝Griffin](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/03_数据治理/数据质量/开源实现/Griffin.md)
                        * [📝数据质量](/docs/开发者知识文档/11_云平台/02_产品/11_数据平台/04_开发套件/03_数据治理/数据质量/数据质量.md)
            * 🗂数仓建设
                * 🗂建模
