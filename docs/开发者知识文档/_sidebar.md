                ...
                * 🗂应用框架
                    ...
                    * 🗂vue相关
                        ...
                        * 🗂基于vue的库和框架
                            ...
                            * [📝移动端vant](/docs/开发者知识文档/10_WebApp/01_前端/03_javascript/框架/应用框架/vue相关/基于vue的库和框架/移动端vant.md)
                * 🗂测试框架
...
* 🗂数据平台
    * 🗂整体解决方案
        * 🗂商业
            * [📝GoogleAnalytics](/docs/开发者知识文档/11_数据平台/00_整体解决方案/商业/GoogleAnalytics.md)
            * [📝GrowingIO](/docs/开发者知识文档/11_数据平台/00_整体解决方案/商业/GrowingIO.md)
            * [📝dataphin](/docs/开发者知识文档/11_数据平台/00_整体解决方案/商业/dataphin.md)
            * [📝dataworks](/docs/开发者知识文档/11_数据平台/00_整体解决方案/商业/dataworks.md)
            * 🗂云数仓
                * [📝Databricks](/docs/开发者知识文档/11_数据平台/00_整体解决方案/商业/云数仓/Databricks.md)
                * [📝Snowflake](/docs/开发者知识文档/11_数据平台/00_整体解决方案/商业/云数仓/Snowflake.md)
            * [📝神策数据](/docs/开发者知识文档/11_数据平台/00_整体解决方案/商业/神策数据.md)
    ...
    * 🗂理论概念
        * [📝OLAP](/docs/开发者知识文档/11_数据平台/00_理论概念/OLAP.md)
        * [📝PLTP](/docs/开发者知识文档/11_数据平台/00_理论概念/PLTP.md)
        * 🗂规范
            * [📝上线规范](/docs/开发者知识文档/11_数据平台/00_理论概念/规范/上线规范.md)
            * [📝开发规范](/docs/开发者知识文档/11_数据平台/00_理论概念/规范/开发规范.md)
            * [📝模型规范](/docs/开发者知识文档/11_数据平台/00_理论概念/规范/模型规范.md)
            * [📝运维规范](/docs/开发者知识文档/11_数据平台/00_理论概念/规范/运维规范.md)
        * [📝质量](/docs/开发者知识文档/11_数据平台/00_理论概念/质量.md)
    * 🗂计算存储
        * 🗂存储
            * 🗂DB
                * 🗂MPP-DB
                ...
                * 🗂hbase
                    ...
                    * [📝phoenix](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/DB/hbase/phoenix.md)
                * [📝lsm-tree](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/DB/lsm-tree.md)
                * 🗂图数据库
                    * [📝HugeGraph](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/DB/图数据库/HugeGraph.md)
                    * 🗂图计算框架
                        * [📝Gremlin_TinkerPop](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/DB/图数据库/图计算框架/Gremlin_TinkerPop.md)
            * 🗂数据格式
                * [📝Apache_Avro](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/数据格式/Apache_Avro.md)
                * [📝Arrow](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/数据格式/Arrow.md)
                * [📝ORC](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/数据格式/ORC.md)
                * [📝Parquet](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/数据格式/Parquet.md)
                * [📝protobuf](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/数据格式/protobuf.md)
            * 🗂文件系统
                * [📝hdfs](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/文件系统/hdfs.md)
        * 🗂资源调度
            * [📝yarn](/docs/开发者知识文档/11_数据平台/01_计算存储/2_资源调度/yarn.md)
        * 🗂计算引擎
            * 🗂引擎
                * 🗂ETL
                    * [📝FiveTran](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/ETL/FiveTran.md)
                    * [📝Informatica](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/ETL/Informatica.md)
                    * [📝Kettle](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/ETL/Kettle.md)
                    * [📝Talend](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/ETL/Talend.md)
                * 🗂Flink
                    * [📝Lynda_Apache_Flink_Batch_Mode_Data_Engineering](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Flink/Lynda_Apache_Flink_Batch_Mode_Data_Engineering.md)
                    * [📝Lynda_Apache_Flink_Exploratory_Data_Analytics_with_SQL](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Flink/Lynda_Apache_Flink_Exploratory_Data_Analytics_with_SQL.md)
                    * [📝Lynda_Apache_Flink_Real-Time_Data_Engineering](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Flink/Lynda_Apache_Flink_Real-Time_Data_Engineering.md)
                    * [📝flink](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Flink/flink.md)
                ...
                * 🗂SQL和脚本引擎
                    ...
                    * [📝pig](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/SQL和脚本引擎/pig.md)
                    * [📝sparkSQL](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/SQL和脚本引擎/sparkSQL.md)
                * 🗂Spark
                    * [📝Lynda_Apache_Spark_Essential_Training](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Spark/Lynda_Apache_Spark_Essential_Training.md)
                    * [📝Lynda_Big_Data_Analytics_with_Hadoop_and_Apache_Spark](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Spark/Lynda_Big_Data_Analytics_with_Hadoop_and_Apache_Spark.md)
                    * [📝Lynda_Introduction_to_Spark_SQL_and_DataFrames](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Spark/Lynda_Introduction_to_Spark_SQL_and_DataFrames.md)
                    * [📝kyuubi](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Spark/kyuubi.md)
            ...
            * 🗂数据湖技术
                * [📝DeltaLake](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/02_数据湖技术/DeltaLake.md)
                * [📝Hudi](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/02_数据湖技术/Hudi.md)
                * [📝Iceberg](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/02_数据湖技术/Iceberg.md)
                * [📝hive-acid](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/02_数据湖技术/hive-acid.md)
                * [📝总览](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/02_数据湖技术/总览.md)
            * 🗂Query统一平台
    ...
    * 🗂计算中间层
        * [📝Linkis](/docs/开发者知识文档/11_数据平台/02_计算中间层/Linkis.md)
    * 🗂开发套件
        * 🗂数据研发
            * 🗂数据集成
                ...
                * [📝Sqoop](/docs/开发者知识文档/11_数据平台/03_开发套件/01_数据研发/00_数据集成/Sqoop.md)
                * [📝holder](/docs/开发者知识文档/11_数据平台/03_开发套件/01_数据研发/00_数据集成/holder.md)
            * 🗂调度系统
                * 🗂开源实现
            ...
            * 🗂任务实例运维
                * [📝基线预警告警](/docs/开发者知识文档/11_数据平台/03_开发套件/01_数据研发/02_任务实例运维/基线预警告警.md)
        ...
        * 🗂数据资产
            ...
            * 🗂数据地图_血缘关系
                * 🗂开源实现
                    * [📝DataHub](/docs/开发者知识文档/11_数据平台/03_开发套件/02_数据资产/数据地图_血缘关系/开源实现/DataHub.md)
                    * [📝amundsen](/docs/开发者知识文档/11_数据平台/03_开发套件/02_数据资产/数据地图_血缘关系/开源实现/amundsen.md)
                    * [📝atlas](/docs/开发者知识文档/11_数据平台/03_开发套件/02_数据资产/数据地图_血缘关系/开源实现/atlas.md)
                * [📝数据地图_血缘关系](/docs/开发者知识文档/11_数据平台/03_开发套件/02_数据资产/数据地图_血缘关系/数据地图_血缘关系.md)
        * 🗂数据治理
            * [📝SLA治理](/docs/开发者知识文档/11_数据平台/03_开发套件/03_数据治理/SLA治理.md)
            * [📝成本优化_元数仓](/docs/开发者知识文档/11_数据平台/03_开发套件/03_数据治理/成本优化_元数仓.md)
            * [📝数据合规_删除和脱敏](/docs/开发者知识文档/11_数据平台/03_开发套件/03_数据治理/数据合规_删除和脱敏.md)
            * 🗂数据安全_权限管理
                * 🗂开源实现
                    * [📝ranger](/docs/开发者知识文档/11_数据平台/03_开发套件/03_数据治理/数据安全_权限管理/开源实现/ranger.md)
                    * [📝sentry](/docs/开发者知识文档/11_数据平台/03_开发套件/03_数据治理/数据安全_权限管理/开源实现/sentry.md)
                * [📝数据安全_权限管理](/docs/开发者知识文档/11_数据平台/03_开发套件/03_数据治理/数据安全_权限管理/数据安全_权限管理.md)
            * 🗂数据质量
                * 🗂开源实现
                    * [📝Griffin](/docs/开发者知识文档/11_数据平台/03_开发套件/03_数据治理/数据质量/开源实现/Griffin.md)
                * [📝数据质量](/docs/开发者知识文档/11_数据平台/03_开发套件/03_数据治理/数据质量/数据质量.md)
    * 🗂数仓建设
        * 🗂建模
            * [📝纬度建模](/docs/开发者知识文档/11_数据平台/04_数仓建设/建模/纬度建模.md)
            * [📝范式建模](/docs/开发者知识文档/11_数据平台/04_数仓建设/建模/范式建模.md)
        * [📝数据层级](/docs/开发者知识文档/11_数据平台/04_数仓建设/数据层级.md)
    * 🗂数据分析
        * 🗂AB测试
            * [📝holder](/docs/开发者知识文档/11_数据平台/05_数据分析/AB测试/holder.md)
        * 🗂数据分析
            * [📝DataStory](/docs/开发者知识文档/11_数据平台/05_数据分析/数据分析/DataStory.md)
            * [📝数据建模](/docs/开发者知识文档/11_数据平台/05_数据分析/数据分析/数据建模.md)
        * 🗂数据可视化
            * [📝dataV](/docs/开发者知识文档/11_数据平台/05_数据分析/数据可视化/dataV.md)
            * [📝esForHadoop](/docs/开发者知识文档/11_数据平台/05_数据分析/数据可视化/esForHadoop.md)
            * [📝jeecy](/docs/开发者知识文档/11_数据平台/05_数据分析/数据可视化/jeecy.md)
            * [📝vueDataV](/docs/开发者知识文档/11_数据平台/05_数据分析/数据可视化/vueDataV.md)
        * 🗂机器学习
            * 🗂python
                * 🗂IDE
                    * [📝PyCharm](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/IDE/PyCharm.md)
                * 🗂python发行版
                    * [📝Anaconda](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/python发行版/Anaconda.md)
                * 🗂基础
                    * [📝Lynda_Python_Essential_Training](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/基础/Lynda_Python_Essential_Training.md)
                    * [📝python](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/基础/python.md)
                    * 🗂标准库
                        * [📝标准库](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/基础/标准库/标准库.md)
                    * 🗂解释器
                        * [📝cpy](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/基础/解释器/cpy.md)
                        * [📝pypy](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/基础/解释器/pypy.md)
                * 🗂实用工具
                    * 🗂包管理
                        * [📝pip3](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/包管理/00_pip3.md)
                        * [📝Conda](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/包管理/Conda.md)
                        * [📝PyPI](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/包管理/PyPI.md)
                        * [📝requirement.txt](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/包管理/requirement.txt.md)
                    * 🗂虚拟环境管理
                        * [📝venv](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/虚拟环境管理/00_venv.md)
                        * [📝Miniconda](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/虚拟环境管理/Miniconda.md)
                        * [📝hatch](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/虚拟环境管理/hatch.md)
                        * [📝pipenv](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/虚拟环境管理/pipenv.md)
                        * [📝poetry](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/虚拟环境管理/poetry.md)
                        * [📝pyenv](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/虚拟环境管理/pyenv.md)
                        * [📝virtualenv](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/实用工具/虚拟环境管理/virtualenv.md)
                * 🗂库
                    * 🗂串口通信库
                        * [📝pyserial](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/库/串口通信库/pyserial.md)
                    * 🗂图像处理库
                        * [📝Pillow](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/库/图像处理库/Pillow.md)
                    * 🗂工具库
                        * [📝pyutil](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/库/工具库/pyutil.md)
                    * 🗂数值计算库
                        * [📝numpy](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/库/数值计算库/numpy.md)
                        * [📝pandas](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/库/数值计算库/pandas.md)
                        * [📝scipy](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/库/数值计算库/scipy.md)
                    * 🗂流水线构建
                        * [📝luigi](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/库/流水线构建/luigi.md)
                    * 🗂算法库
                        * [📝XGBoost](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/库/算法库/XGBoost.md)
                    * 🗂语言处理库
                        * [📝jieba分词](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/库/语言处理库/jieba分词.md)
                * 🗂框架
                    * 🗂ORM
                        * [📝MongoEngine](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/ORM/MongoEngine.md)
                        * [📝SQLALchemy](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/ORM/SQLALchemy.md)
                        * [📝peewee](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/ORM/peewee.md)
                        * [📝pymongo](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/ORM/pymongo.md)
                    * 🗂web框架
                        * 🗂Django
                            * [📝Django](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/web框架/Django/00_Django.md)
                            * [📝django-admin](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/web框架/Django/django-admin.md)
                        * 🗂Flask
                            * [📝Flask](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/web框架/Flask/00_Flask.md)
                            * 🗂管理面
                                * [📝Flask-Admin](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/web框架/Flask/管理面/Flask-Admin.md)
                            * 🗂认证授权
                                * [📝Flask-BasicAuth](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/web框架/Flask/认证授权/Flask-BasicAuth.md)
                                * [📝Flask-Login](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/web框架/Flask/认证授权/Flask-Login.md)
                    * 🗂微服务
                        * [📝Euler微服务框架](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/微服务/Euler微服务框架.md)
                    * 🗂数据看板_画板
                        * [📝dash-Plotly](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/数据看板_画板/dash-Plotly.md)
                    * 🗂深度学习框架
                        * 🗂Keras
                            * [📝Lynda_Neural_Networks_and_Convolutional_Neural_Networks_Essential_Training](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/深度学习框架/Keras/Lynda_Neural_Networks_and_Convolutional_Neural_Networks_Essential_Training.md)
                            * [📝keras](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/深度学习框架/Keras/keras.md)
                        * 🗂PyTorch
                            * [📝Lynda_PyTorch_Essential_Training_Deep_Learning](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/深度学习框架/PyTorch/Lynda_PyTorch_Essential_Training_Deep_Learning.md)
                            * [📝PyTorch](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/深度学习框架/PyTorch/PyTorch.md)
                        * [📝tensorflow](/docs/开发者知识文档/11_数据平台/05_数据分析/机器学习/python/框架/深度学习框架/tensorflow.md)
    * 🗂数据应用
        * [📝用户画像](/docs/开发者知识文档/11_数据平台/06_数据应用/用户画像.md)
    * 🗂hadoop和发行版
        * 🗂CDH
            * [📝HUE](/docs/开发者知识文档/11_数据平台/07_hadoop和发行版/CDH/HUE.md)
        * [📝Lynda_Learning_Hadoop](/docs/开发者知识文档/11_数据平台/07_hadoop和发行版/Lynda_Learning_Hadoop.md)
        * [📝ambari](/docs/开发者知识文档/11_数据平台/07_hadoop和发行版/ambari.md)
        * [📝cloudera_sandbox](/docs/开发者知识文档/11_数据平台/07_hadoop和发行版/cloudera_sandbox.md)
        * [📝cloudera发行版安装包](/docs/开发者知识文档/11_数据平台/07_hadoop和发行版/cloudera发行版安装包.md)
        * [📝hadoop](/docs/开发者知识文档/11_数据平台/07_hadoop和发行版/hadoop.md)
        * [📝最佳实践](/docs/开发者知识文档/11_数据平台/07_hadoop和发行版/最佳实践.md)
* 🗂GNU-Linux
    * 🗂c
        * 🗂c版本
...
* 🗂中间件
    * 🗂CMS网站生成器
        * [📝MCms](/docs/开发者知识文档/21_中间件/CMS网站生成器/MCms.md)
    * 🗂LSP语言服务器协议
        * [📝ms-lsp](/docs/开发者知识文档/21_中间件/LSP语言服务器协议/ms-lsp.md)
    * 🗂分布式事务
        * [📝seata](/docs/开发者知识文档/21_中间件/分布式事务/seata.md)
    * 🗂分布式调度与计算框架
        * [📝PowerJob](/docs/开发者知识文档/21_中间件/分布式调度与计算框架/PowerJob.md)
    * 🗂存储
        * 🗂存储排列组合
            * 🗂块-对象
                * [📝Sheepdog](/docs/开发者知识文档/21_中间件/存储/01_存储排列组合/块-对象/Sheepdog.md)
                * [📝Swift](/docs/开发者知识文档/21_中间件/存储/01_存储排列组合/块-对象/Swift.md)
            * 🗂块-对象-文件
                * 🗂分布式存储
                    * [📝Ceph](/docs/开发者知识文档/21_中间件/存储/01_存储排列组合/块-对象-文件/分布式存储/Ceph.md)
            * 🗂对象
                * [📝minIO](/docs/开发者知识文档/21_中间件/存储/01_存储排列组合/对象/minIO.md)
            * 🗂文件
                * [📝总览](/docs/开发者知识文档/21_中间件/存储/01_存储排列组合/文件/总览.md)
        * 🗂DB
            * 🗂数据库产品
                * 🗂SQL数据库
                ...
                * 🗂NoSQL数据库
                    ...
                    * 🗂图形数据库
                        * [📝Neo4j](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/01_NoSQL数据库/03_图形数据库/Neo4j.md)
                    * 🗂文档类型
                        * [📝mongodb](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/01_NoSQL数据库/04_文档类型/mongodb.md)
                    * 🗂时序类
                        * [📝OpenTSDB](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/01_NoSQL数据库/05_时序类/OpenTSDB.md)
                        * [📝influxdb](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/01_NoSQL数据库/05_时序类/influxdb.md)
                    * [📝Cassandra](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/01_NoSQL数据库/Cassandra.md)
                    * [📝Couchbase](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/01_NoSQL数据库/Couchbase.md)
                * 🗂NewSQL
                    * [📝PolarDB](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/02_NewSQL/PolarDB.md)
                    * [📝TiDB](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/02_NewSQL/TiDB.md)
                    * [📝oceanDB](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/02_NewSQL/oceanDB.md)
                * [📝Druid](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/Druid.md)
                * [📝Kudu](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/Kudu.md)
                * [📝db2](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库产品/db2.md)
            * [📝数据库理论](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库理论.md)
            * 🗂数据库迁移
                * [📝flyway](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库迁移/flyway.md)
                * [📝liquibase](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库迁移/liquibase.md)
            * 🗂数据库锁
                * [📝乐观锁](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库锁/乐观锁.md)
                * [📝互斥锁](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库锁/互斥锁.md)
                * [📝悲观锁](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库锁/悲观锁.md)
                * [📝自旋锁](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库锁/自旋锁.md)
                * [📝读写锁](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库锁/读写锁.md)
            * 🗂数据库集群
                * 🗂主从读写分离-负载平衡
                    * 🗂mysql
                        * [📝总览](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/00_总览.md)
                        * [📝Atlas](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/Atlas.md)
                        * [📝MaxScale](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/MaxScale.md)
                        * [📝MyCat](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/MyCat.md)
                        * [📝mysql-proxy](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/mysql-proxy.md)
                        * [📝proxysql](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库集群/主从读写分离-负载平衡/mysql/proxysql.md)
                    * 🗂postgresql
                        * [📝Pgpool](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库集群/主从读写分离-负载平衡/postgresql/Pgpool.md)
                        * [📝PlProxy](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库集群/主从读写分离-负载平衡/postgresql/PlProxy.md)
                * 🗂分库分表
                    * [📝ShardingSphere](/docs/开发者知识文档/21_中间件/存储/04_DB/数据库集群/分库分表/ShardingSphere.md)
        * 🗂keyvalue存储
            * [📝minikeyvalue](/docs/开发者知识文档/21_中间件/存储/05_keyvalue存储/minikeyvalue.md)
        * 🗂搜索引擎
            * [📝搜索引擎概述](/docs/开发者知识文档/21_中间件/存储/06_搜索引擎/00_搜索引擎概述.md)
            * [📝elasticsearch](/docs/开发者知识文档/21_中间件/存储/06_搜索引擎/elasticsearch.md)
            * [📝solr](/docs/开发者知识文档/21_中间件/存储/06_搜索引擎/solr.md)
            * [📝sphinx](/docs/开发者知识文档/21_中间件/存储/06_搜索引擎/sphinx.md)
        * 🗂一致性
            * [📝Consul_by_Hashicorp](/docs/开发者知识文档/21_中间件/存储/07_一致性/Consul_by_Hashicorp.md)
        ...
        * 🗂Cache
            * 🗂分布式缓存
                ...
                * [📝infinispan](/docs/开发者知识文档/21_中间件/存储/09_Cache/分布式缓存/infinispan.md)
                * [📝memcache](/docs/开发者知识文档/21_中间件/存储/09_Cache/分布式缓存/memcache.md)
                * 🗂redis
                    * 🗂Redis高可用
                        * [📝高可用](/docs/开发者知识文档/21_中间件/存储/09_Cache/分布式缓存/redis/Redis高可用/高可用.md)
                    * [📝codis](/docs/开发者知识文档/21_中间件/存储/09_Cache/分布式缓存/redis/codis.md)
                    * [📝redis](/docs/开发者知识文档/21_中间件/存储/09_Cache/分布式缓存/redis/redis.md)
            * 🗂本地缓存
    ...
    * 🗂序列化
        * [📝JSON_Schema](/docs/开发者知识文档/21_中间件/序列化/JSON_Schema.md)
    * 🗂开发脚手架
        * 🗂JHipster
            * [📝jHipster](/docs/开发者知识文档/21_中间件/开发脚手架/JHipster/jHipster.md)
            * [📝jhipster-devbox](/docs/开发者知识文档/21_中间件/开发脚手架/JHipster/jhipster-devbox.md)
    * 🗂待分类_by_redHat
        * 🗂redhat_middleware
            * [📝quarkus](/docs/开发者知识文档/21_中间件/待分类_by_redHat/redhat_middleware/quarkus.md)
            * [📝redHat_runtimes](/docs/开发者知识文档/21_中间件/待分类_by_redHat/redhat_middleware/redHat_runtimes.md)
    * 🗂消息中间件
        * [📝AMQP协议](/docs/开发者知识文档/21_中间件/消息中间件/AMQP协议.md)
        * 🗂Pulsar.md
            * [📝pulsar_apache](/docs/开发者知识文档/21_中间件/消息中间件/Pulsar.md/pulsar_apache.md)
        * 🗂ZeroMQ
            * [📝ZeroMQ](/docs/开发者知识文档/21_中间件/消息中间件/ZeroMQ/ZeroMQ.md)
        * 🗂activemq
            * [📝activemq](/docs/开发者知识文档/21_中间件/消息中间件/activemq/01_activemq.md)
        * 🗂kafka
            * [📝kafka](/docs/开发者知识文档/21_中间件/消息中间件/kafka/03_kafka.md)
            * 🗂confluent
                * [📝ConfluentSchemaRegistry](/docs/开发者知识文档/21_中间件/消息中间件/kafka/confluent/ConfluentSchemaRegistry.md)
                * [📝Kafka-Schema-Registry](/docs/开发者知识文档/21_中间件/消息中间件/kafka/confluent/Kafka-Schema-Registry.md)
                * [📝apache_confluent](/docs/开发者知识文档/21_中间件/消息中间件/kafka/confluent/apache_confluent.md)
        * [📝nsq](/docs/开发者知识文档/21_中间件/消息中间件/nsq.md)
        * 🗂rabbitMQ
            * [📝rabbitMQ](/docs/开发者知识文档/21_中间件/消息中间件/rabbitMQ/02_rabbitMQ.md)
        * 🗂rocketMQ
            * [📝rocketMQ](/docs/开发者知识文档/21_中间件/消息中间件/rocketMQ/04_rocketMQ.md)
    ...
    * 🗂网关
        * 🗂API网关
            ...
            * [📝apisix](/docs/开发者知识文档/21_中间件/网关/API网关/apisix.md)
        * 🗂Java应用服务器
            * [📝apache](/docs/开发者知识文档/21_中间件/网关/Java应用服务器/apache.md)
            * [📝jetty](/docs/开发者知识文档/21_中间件/网关/Java应用服务器/jetty.md)
            * [📝tomcat](/docs/开发者知识文档/21_中间件/网关/Java应用服务器/tomcat.md)
            * [📝undertow](/docs/开发者知识文档/21_中间件/网关/Java应用服务器/undertow.md)
            * 🗂全功能JakartaEE标准服务器
                * [📝GlassFish](/docs/开发者知识文档/21_中间件/网关/Java应用服务器/全功能JakartaEE标准服务器/GlassFish.md)
                * [📝WildFly_JBoss](/docs/开发者知识文档/21_中间件/网关/Java应用服务器/全功能JakartaEE标准服务器/WildFly_JBoss.md)
        * 🗂Python应用服务器
    ...
    * 🗂负载均衡
        * [📝f5](/docs/开发者知识文档/21_中间件/负载均衡/f5.md)
        * [📝lvs](/docs/开发者知识文档/21_中间件/负载均衡/lvs.md)
    * 🗂集群管理器
