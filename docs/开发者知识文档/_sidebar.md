...
* 🗂软件开发
        ...
        * 🗂java
            ...
            * 🗂框架
                * 🗂spring全家桶
                    ...
                    * 🗂springCloud
                        * [📝Nacos_by_alibaba](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/03_springCloud/Nacos_by_alibaba.md)
                        * [📝Ribbon_by_Netflix](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/03_springCloud/Ribbon_by_Netflix.md)
                        * [📝Sleuth和zipkin](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/03_springCloud/Sleuth和zipkin.md)
                        * [📝configServer](/docs/开发者知识文档/01_软件开发/02_后端/java/05_框架/01_spring全家桶/03_springCloud/configServer.md)
    ...
    * 🗂数据平台
        ...
        * 🗂开发套件
            ...
            * 🗂数据治理
                * [📝SLA治理](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/SLA治理.md)
                * [📝成本优化_元数仓](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/成本优化_元数仓.md)
                * [📝指标](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/指标.md)
                * [📝数据合规_用户数据删除](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/数据合规_用户数据删除.md)
                * 🗂数据地图_血缘关系
                    * 🗂开源实现
                        * [📝atlas](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/数据地图_血缘关系/开源实现/atlas.md)
                    * [📝数据地图_血缘关系](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/数据地图_血缘关系/数据地图_血缘关系.md)
                * 🗂数据安全_权限管理
                    * 🗂开源实现
                        * [📝ranger](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/数据安全_权限管理/开源实现/ranger.md)
                        * [📝sentry](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/数据安全_权限管理/开源实现/sentry.md)
                    * [📝数据安全_权限管理](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/数据安全_权限管理/数据安全_权限管理.md)
                * 🗂数据质量
                    * 🗂开源实现
                        * [📝Griffin](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/数据质量/开源实现/Griffin.md)
                    * [📝数据质量](/docs/开发者知识文档/01_软件开发/03_数据平台/02_开发套件/03_数据治理/数据质量/数据质量.md)
        * 🗂湖仓一体
            * 🗂数据仓库DataWarehouse
                * [📝接入层](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据仓库DataWarehouse/1_接入层.md)
                * [📝中间层](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据仓库DataWarehouse/2_中间层.md)
                * [📝应用层](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据仓库DataWarehouse/3_应用层.md)
                * 🗂云数仓
                    * [📝Databricks](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据仓库DataWarehouse/云数仓/Databricks.md)
                    * [📝Snowflake](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据仓库DataWarehouse/云数仓/Snowflake.md)
            * 🗂数据湖DataLake
                * [📝Hudi](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据湖DataLake/Hudi.md)
                * [📝Iceberg](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据湖DataLake/Iceberg.md)
                * [📝clickhouse](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据湖DataLake/clickhouse.md)
                * [📝delta](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据湖DataLake/delta.md)
                * [📝hive-acid](/docs/开发者知识文档/01_软件开发/03_数据平台/03_湖仓一体/数据湖DataLake/hive-acid.md)
        * 🗂数据分析
            * 🗂AB测试
...
* 🗂GNU-Linux
    ...
    * 🗂其他发行版
        ...
        * [📝arch](/docs/开发者知识文档/02_GNU-Linux/05_其他发行版/arch.md)
        ...
        * [📝elementary](/docs/开发者知识文档/02_GNU-Linux/05_其他发行版/elementary.md)
        * [📝kali](/docs/开发者知识文档/02_GNU-Linux/05_其他发行版/kali.md)
        * [📝manjaro](/docs/开发者知识文档/02_GNU-Linux/05_其他发行版/manjaro.md)
        * [📝openSUSE](/docs/开发者知识文档/02_GNU-Linux/05_其他发行版/openSUSE.md)
        * [📝openWrt](/docs/开发者知识文档/02_GNU-Linux/05_其他发行版/openWrt.md)
        * [📝redhat](/docs/开发者知识文档/02_GNU-Linux/05_其他发行版/redhat.md)
        * [📝slackware](/docs/开发者知识文档/02_GNU-Linux/05_其他发行版/slackware.md)
        * [📝tails](/docs/开发者知识文档/02_GNU-Linux/05_其他发行版/tails.md)
    * 🗂Linux社区项目
        * 🗂文档
    ...
    * 🗂工具软件
        ...
        * 🗂session管理
            * [📝ssh](/docs/开发者知识文档/02_GNU-Linux/工具软件/session管理/ssh.md)
            * [📝tmux](/docs/开发者知识文档/02_GNU-Linux/工具软件/session管理/tmux.md)
        * 🗂内核调试
            * [📝kgdb](/docs/开发者知识文档/02_GNU-Linux/工具软件/内核调试/kgdb.md)
            * [📝kprobe](/docs/开发者知识文档/02_GNU-Linux/工具软件/内核调试/kprobe.md)
        * 🗂切割文件
            * [📝logrotate](/docs/开发者知识文档/02_GNU-Linux/工具软件/切割文件/logrotate.md)
        * 🗂性能监控
            * [📝DTrace](/docs/开发者知识文档/02_GNU-Linux/工具软件/性能监控/DTrace.md)
        * 🗂查看文件
            * [📝awk](/docs/开发者知识文档/02_GNU-Linux/工具软件/查看文件/awk.md)
            * [📝find](/docs/开发者知识文档/02_GNU-Linux/工具软件/查看文件/find.md)
            * [📝grep](/docs/开发者知识文档/02_GNU-Linux/工具软件/查看文件/grep.md)
            * [📝kill](/docs/开发者知识文档/02_GNU-Linux/工具软件/查看文件/kill.md)
            * 🗂阅读文本
                * [📝less](/docs/开发者知识文档/02_GNU-Linux/工具软件/查看文件/阅读文本/less.md)
                * [📝more](/docs/开发者知识文档/02_GNU-Linux/工具软件/查看文件/阅读文本/more.md)
                * [📝most](/docs/开发者知识文档/02_GNU-Linux/工具软件/查看文件/阅读文本/most.md)
                * [📝tail](/docs/开发者知识文档/02_GNU-Linux/工具软件/查看文件/阅读文本/tail.md)
                * [📝view](/docs/开发者知识文档/02_GNU-Linux/工具软件/查看文件/阅读文本/view.md)
        * [📝汇总](/docs/开发者知识文档/02_GNU-Linux/工具软件/汇总.md)
        * 🗂汇编相关
            * [📝objdump](/docs/开发者知识文档/02_GNU-Linux/工具软件/汇编相关/objdump.md)
        * 🗂系统监控
            * [📝top](/docs/开发者知识文档/02_GNU-Linux/工具软件/系统监控/top.md)
        * 🗂编辑文件
            * [📝emacs](/docs/开发者知识文档/02_GNU-Linux/工具软件/编辑文件/emacs.md)
            * [📝nano](/docs/开发者知识文档/02_GNU-Linux/工具软件/编辑文件/nano.md)
            * [📝sed](/docs/开发者知识文档/02_GNU-Linux/工具软件/编辑文件/sed.md)
            * [📝vi](/docs/开发者知识文档/02_GNU-Linux/工具软件/编辑文件/vi.md)
            * [📝vim](/docs/开发者知识文档/02_GNU-Linux/工具软件/编辑文件/vim.md)
        * 🗂网络相关
            * [📝WireGuard](/docs/开发者知识文档/02_GNU-Linux/工具软件/网络相关/WireGuard.md)
            * [📝ip](/docs/开发者知识文档/02_GNU-Linux/工具软件/网络相关/ip.md)
            * [📝iptable](/docs/开发者知识文档/02_GNU-Linux/工具软件/网络相关/iptable.md)
            * [📝ipvadm](/docs/开发者知识文档/02_GNU-Linux/工具软件/网络相关/ipvadm.md)
            * [📝nc](/docs/开发者知识文档/02_GNU-Linux/工具软件/网络相关/nc.md)
            * [📝netstat](/docs/开发者知识文档/02_GNU-Linux/工具软件/网络相关/netstat.md)
            * [📝ping](/docs/开发者知识文档/02_GNU-Linux/工具软件/网络相关/ping.md)
            * [📝route](/docs/开发者知识文档/02_GNU-Linux/工具软件/网络相关/route.md)
            * [📝tcpdump](/docs/开发者知识文档/02_GNU-Linux/工具软件/网络相关/tcpdump.md)
        * 🗂进程相关
