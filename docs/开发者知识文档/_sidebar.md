...
* 🗂数据平台
    ...
    * 🗂计算存储
        ...
        * 🗂存储
            ...
            * 🗂数据格式
                ...
                * [📝Velox](/docs/开发者知识文档/11_数据平台/01_计算存储/1_存储/数据格式/Velox.md)
        ...
        * 🗂计算引擎
            * 🗂引擎
                ...
                * 🗂Spark
                    ...
                    * 🗂ml_Lib
                        * [📝SynapseML](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Spark/ml_Lib/SynapseML.md)
                    * [📝spark](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Spark/spark.md)
                * [📝Tez](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Tez.md)
                * [📝Trino](/docs/开发者知识文档/11_数据平台/01_计算存储/3_计算引擎/01_引擎/Trino.md)
    ...
    * 🗂数据应用
        ...
        * 🗂推荐系统
            * [📝推荐系统](/docs/开发者知识文档/11_数据平台/05_数据应用/推荐系统/推荐系统.md)
        * 🗂数据分析
